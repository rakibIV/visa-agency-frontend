...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-green-500 text-white rounded-full shadow-2xl hover:scale-110 hover:bg-green-600 transition-all duration-300"
    ...
    >
      ...
      <div className="absolute -inset-2 rounded-full border-2 border-green-500 animate-pulse opacity-30"></div>
    </a>
  );
}
